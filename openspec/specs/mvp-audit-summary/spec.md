...
the same fixed action/outcome shapes required by strict MVP evidence: host
authorization approval, host active visible authorization, host screen frame
sent, host permission revocation, host disconnect or terminal lifecycle
