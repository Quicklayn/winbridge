...
- Emits structured development audit records for joins, denials, forwarding, and disconnects; accepted signal-forwarding audit includes the non-secret `authorizationId` but not raw signal payload contents.
